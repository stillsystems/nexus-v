...
### Brand Promise
Tools engineered for real‑world conditions.
...
### Layout & Spacing
4‑point spacing scale: 4 / 8 / 12 / 16 / 24 / 32 / 48.
...
## 4. Voice & Tone
See `voice-tone/voice-guide.md`.

---

## 5. CLI & Product Design Language
See `cli-style/cli-formatting.md`.
