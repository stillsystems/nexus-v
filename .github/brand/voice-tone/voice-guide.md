...
3. **Inclusive**: We avoid jargon where a simple word works better.
...
- **Use**: *Engineered, Durable, Predictable, Scaffold, Hardened.*
- **Avoid**: *Magic, Disruptive, Revolutionary, Easy (use "Simple" instead).*
