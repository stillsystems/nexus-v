...
- `banners/` — GitHub and social header assets
- `icons/` — Iconography rules and icon sets
- `patterns/` — Backgrounds, overlays, and blueprint patterns
- `templates/` — README, docs, and communication templates
- `voice-tone/` — Voice, tone, and reusable phrasing
